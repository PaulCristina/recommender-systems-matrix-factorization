...
3. api_reco, which will deliver recommendation for a user using an API
...
The model runs extremly fast, it can generate recommendation in ~ 300 secs for 138286 users for ALS and in ~ 200 secs for 8546 using cosine distance.
