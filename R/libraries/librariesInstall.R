...
install.packages('stringi', version = "1.4.5", repos='http://cran.us.r-project.org', depencencies = TRUE)
## Exploratory Data Analysis
install.packages('summarytools', version = "0.9.3", repos='http://cran.us.r-project.org', depencencies = TRUE)
# Json
install.packages('jsonlite', version = "1.6", repos='http://cran.us.r-project.org', depencencies = TRUE)
## Time tracking
install.packages('tictoc', version = "1.0", repos='http://cran.us.r-project.org', depencencies = TRUE)
## Environment variables
# usethis)
## Data transformations
install.packages('tidyverse', version = "1.2.1", repos='http://cran.us.r-project.org', depencencies = TRUE)
install.packages('data.table', version = "1.12.2", repos='http://cran.us.r-project.org', depencencies = TRUE)
